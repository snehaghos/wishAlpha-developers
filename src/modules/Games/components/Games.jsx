...
function Games() {
  ...
  const getSubdomain = () => {
    ...
    if (parts.length > 2 && parts[0].startsWith("game-")) {
      return parts[0].replace("game-", "");
    }
    return null;
  };
              ...
              {games.map((game) => (
                ...
                >
                  ...
                  <div className="text-center mt-4">
                    ...
                    <button
                      className="bg-purple-600 cursor-pointer hover:bg-purple-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-purple-500 w-full"
                      onClick={() => setSelectedGame(game.src)}
                    >
                      Play
                    </button>
                  </div>
