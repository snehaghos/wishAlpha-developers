...
function Developers() {
  ...
  return (
    <div className="min-h-screen mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10 bg-[url(/images/2.png)] bg-cover bg-fixed">
      <div className="mb-8 flex flex-col justify-center items-center w-full">
        {/* Updated header section with side-by-side layout on large screens */}
        <div className="flex flex-col md:flex-row w-full max-w-6xl justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="rounded-lg w-full max-w-6xl shadow-2xl overflow-hidden bg-gray-900/80 backdrop-blur-sm overflow-x-auto">
                ...
                filteredDevelopers.map((developer) => (
                  ...
                  >
                    <td className="px-4 py-4 whitespace-nowrap sm:px-6">
                      <img
                        src={developer.profileImageUrl || "/default-avatar.png"}
                        alt={developer.username}
                        className="w-8 h-8 sm:w-10 sm:h-10 rounded-full object-cover border-2 border-gray-700"
                      />
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-200 sm:px-6">
                      {developer.username}
                    </td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-400 sm:px-6 truncate max-w-[150px] sm:max-w-none">
                      {developer.email}
                    </td>
                  </tr>
                ))
